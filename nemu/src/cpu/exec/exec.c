...
opcode_entry opcode_table [512] = {
  ...
  /* 0x08 */	/*IDEX(G2E,or)*/EMPTY, EMPTY, EMPTY, EMPTY,//08-->0D or
  ...
  /* 0x38 */	EMPTY, EMPTY, EMPTY, IDEXW(E2G,cmp,0),//0x3b cmp Gv,Ev
  /* 0x3c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x40 */	EMPTY, EMPTY, EMPTY, IDEX(r,inc),//0x40---->0x47 inc general register
  ...
  /* 0x74 */	IDEXW(J,jcc,1), EMPTY, EMPTY, EMPTY,//0x74 je/jz
  /* 0x78 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x7c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEX(SI2E, gp1),
  /* 0x84 */	EMPTY, IDEXW(G2E,test,0), EMPTY, EMPTY,//0x86 xcng Eb,Gb  //0x85 test Ev,Gv
  ...
  /* 0x94 */	IDEXW(E,setcc,1), EMPTY, EMPTY, EMPTY,//0x94 sete al
  /* 0x98 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x9c */	EMPTY, EMPTY, EMPTY, EMPTY,
