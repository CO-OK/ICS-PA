...
make_group(gp5,
    ...
    EX(jmp_rm), EX(jmp_rm), EX(push_reg), EMPTY)  // 第7个 PUSH Ev
...
opcode_entry opcode_table [512] = {
  /* 0x00 */	EMPTY, IDEXW(G2E,add,0), EMPTY, IDEXW(E2G,add,0),//03 add Gv,Ev  //01 add Ev,GV
  ...
  /* 0x18 */	EMPTY, EMPTY, EMPTY, IDEXW(E2G,sbb,0),//0x1b  sbb Gv,Ev 
  ...
  /* 0x38 */	IDEXW(G2E,cmp,1), IDEXW(G2E,cmp,0), EMPTY, IDEXW(E2G,cmp,0),//0x3b cmp Gv,Ev //0x39 cmp Ev,Gv
  ...
  /* 0xe4 */	IDEXW(in_I2a,in,0), IDEXW(in_I2a,in,0), IDEXW(out_a2I,out,0), IDEXW(out_a2I,out,0),//0xe4 al,Ib
  ...
  /* 0x84 */	IDEXW(J,jcc,0), IDEXW(J,jcc,0), EMPTY, EMPTY,//85 jnz
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G,movzx,0), IDEXW(mov_E2G,movzx,0),//0xb6 movzx Gv,Eb
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G,movsx,1), IDEXW(mov_E2G,movsx,0),// bf  MOVSX Gv,Ew //be movsx Gv,Eb
